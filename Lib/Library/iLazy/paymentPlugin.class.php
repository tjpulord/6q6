...
abstract class paymentPlugin{
    ...
    */
    ...
    {
        //回调函数地址
        $this->callbackUrl          = 'http://'.$_SERVER['HTTP_HOST']."/interface.php/home/notify/callback/payment_id/".$payment_id."/";
        //服务器返回支付结果的报文地址
        $this->serverCallbackUrl    = 'http://'.$_SERVER['HTTP_HOST']."/interface.php/home/notify/servercallback/payment_id/".$payment_id."/";
    }
