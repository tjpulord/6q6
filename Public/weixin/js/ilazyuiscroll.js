...
var ilazyscrollbar = {
    ...
    paramObject:{},
    loaded:function() {
        pullDownEl = document.getElementById(ilazyscrollbar.paramObject.downbtn);
        pullDownOffset = pullDownEl.offsetHeight;
        pullUpEl = document.getElementById(ilazyscrollbar.paramObject.upbtn);
        pullUpOffset = pullUpEl.offsetHeight;
        myScroll = new iScroll(ilazyscrollbar.paramObject.wapper, {
            scrollbarClass: ilazyscrollbar.paramObject.scroll,
            useTransition: false,
            ...
            onScrollEnd: function () {
                try{
                    if (pullDownEl.className.match('flip')) {
                        ...
                        ilazyscrollbar.paramObject.puaction();
                        ilazyscrollbar.pullDownAction();
                    } else if (pullUpEl.className.match('flip')) {
                        pullUpEl.className = 'loading';
                        pullUpEl.querySelector('.pullUpLabel').innerHTML = '加载中...';
                        ilazyscrollbar.paramObject.pdaction();
                        ilazyscrollbar.pullUpAction();
                    }
                }
                    catch(e){}
            }
        });
        setTimeout(function () { document.getElementById(ilazyscrollbar.paramObject.wapper).style.left = '0'; }, 800);
    },
    ...
    init:function(o){
        ilazyscrollbar.paramObject = o;
        document.addEventListener('touchmove', function (e) { e.preventDefault(); }, false);
        document.addEventListener('DOMContentLoaded', ilazyscrollbar.loaded, false);
    }
};
